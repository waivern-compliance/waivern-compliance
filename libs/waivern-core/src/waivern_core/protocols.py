...
See Also:
    ``waivern_core.schemas.BaseFindingModel``: Generic base class that these
    protocols complement. Use generics for the inheritance hierarchy (type-safe
    metadata specialisation), use these protocols for generic code constraints.
