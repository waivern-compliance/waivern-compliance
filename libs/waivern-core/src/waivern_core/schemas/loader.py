"""Schema loader for Waivern Compliance Framework.

This module provides the protocol and implementation for loading schema definitions
from various sources (primarily JSON files).
"""
...
class JsonSchemaLoader:
    ...
    def _generate_schema_paths(self, schema_name: str, version: str) -> list[Path]:
        ...
        if self._custom_search_paths:
            ...
            # Package-relative path (where this loader.py file lives)
