"""Tests for source_code v1.0.0 reader in waivern_crypto_quality_analyser."""
    ...
    "data": [
        {
            ...
            "language": "php",
            "raw_content": "password_hash = md5(password)",
...
MULTI_FILE_INPUT: dict[str, Any] = {
    ...
    "data": [
        ...
        {
            "file_path": "src/crypto.php",
            "language": "php",
            "raw_content": "cipher = blowfish.new(key)",
            "metadata": {"file_size": 50, "line_count": 5, "last_modified": None},
        },
        {
...
class TestSourceCodeReader:
    ...
    def test_read_maps_raw_content_to_item_content(self) -> None:
        ...
        assert result.data[0].content == "password_hash = md5(password)"
    ...
    def test_read_produces_one_item_per_file(self) -> None:
        ...
        assert sources == ["src/auth.php", "src/crypto.php", "src/utils.php"]
