...
@pytest.fixture
def sample_metadata() -> DocumentExtractionMetadata:
...
@pytest.fixture
def sample_config_data() -> DocumentProducerConfig:
...
class TestStandardInputProducer:
    ...
    def test_produce_returns_correct_schema_version(
        self,
        sample_metadata: DocumentExtractionMetadata,
        sample_data_items: list[StandardInputDataItemModel[DocumentDatabaseMetadata]],
        sample_config_data: DocumentProducerConfig,
    ) -> None:
