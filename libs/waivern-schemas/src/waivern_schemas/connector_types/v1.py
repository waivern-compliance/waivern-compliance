...
class DocumentDatabaseMetadata(BaseMetadata):
    """Metadata for data generated by document database connectors (MongoDB, etc.).

    Provides document database context for data subject classification
    and compliance analysis in document-oriented data sources.
    """

    collection_name: str = Field(description="Name of the database collection")
    field_name: str = Field(description="Name of the document field")
