"""Shared helper functions for PHP extraction.
...
# PHP AST node types for callables
FUNCTION_TYPES = ["function_definition"]
METHOD_TYPE = "method_declaration"

# PHP AST node types for type definitions
...
def is_static(node: Node) -> bool:
    ...
    """
    return any(child.type == "static_modifier" for child in node.children)
