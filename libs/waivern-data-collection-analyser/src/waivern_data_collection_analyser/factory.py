"""Factory for creating DataCollectionAnalyser instances."""
...
class DataCollectionAnalyserFactory(ComponentFactory[DataCollectionAnalyser]):
    """Factory for creating DataCollectionAnalyser instances.

    No LLM service dependency — DataCollectionAnalyser is fully deterministic.
    """
    ...
    @override
    def create(self, config: ComponentConfig) -> DataCollectionAnalyser:
        """Create DataCollectionAnalyser instance.
    ...
    def can_create(self, config: ComponentConfig) -> bool:
        ...
        try:
            RulesetManager.get_ruleset(
                analyser_config.pattern_matching.ruleset, DataCollectionRule
            )
        except Exception:
            return False
    ...
    @property
    @override
    def component_class(self) -> type[DataCollectionAnalyser]:
