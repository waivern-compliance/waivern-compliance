"""Result builder for GDPR data collection classification output.
...
class GDPRDataCollectionResultBuilder:
    """Builds output results for GDPR data collection classification.
    ...
    def build_output_message(
        self,
        findings: list[GDPRDataCollectionFindingModel],
        ...
        Args:
            findings: Classified GDPR data collection findings.
        ...
        output = GDPRDataCollectionFindingOutput(
            findings=findings,
            summary=summary,
        ...
        output_message = Message(
            id="gdpr_data_collection_classification",
            content=result_data,
        ...
        logger.info(
            f"GDPRDataCollectionClassifier processed with {len(result_data['findings'])} findings"
        )

        return output_message

    def _build_summary(
        self, findings: list[GDPRDataCollectionFindingModel]
    ) -> GDPRDataCollectionSummary:
        ...
        return GDPRDataCollectionSummary(
