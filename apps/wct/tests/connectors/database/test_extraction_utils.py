...
class TestDatabaseExtractionUtils:
    ...
    def test_filter_non_empty_cell_accepts_valid_content(self):
    ...
    def test_filter_non_empty_cell_rejects_invalid_content(self):
    ...
    def test_create_cell_data_item_creates_correct_structure(self):
    ...
    def test_create_cell_data_item_converts_content_to_string(self):
